...
describe('FormCareerSummary', () => {
  test('renders SummaryForm and handles input', () => {
    render(<FormCareerSummary pitch={''} highlights={[]} competencies={[]} />);
    ...
    expect(pitchInput).toBe('This is a test pitch.');
