...
import { StepsCurriculum, steps } from '../lib/stepsForms/stepsCurriculum';
import { ContainerSeccions } from '@free-resume/resumecomps';
...
export function FormContainer() {
  ...
  return (
    <>
      <StepsCurriculum activeStep={activeStep} setActiveStep={setActiveStep} />
